<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="administracaoConsultaUser.aspx.cs" Inherits="WebZSPrev.Apresentacao.administracaoConsultaUser" %>
        ...
        <script>
            ...
            function excluir(id) {
                ...
                if (r) {
                    ...
                    $.ajax({
                        ...
                        type: "POST",
                        url: "administracaoUser.aspx/excluir",
                        data: strParametros,
                        dataType: "json",
            ...
            function redirect(id, obj) {
                ...
                if (id == null || id === 'undefined') {
                    ...
                    location.href = 'administracaoUser.aspx?item=' + item + '&id=' + id + '&acao=' + acao;
